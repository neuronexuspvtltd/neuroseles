...
export const Sidebar: React.FC<SidebarProps> = ({ mobileOpen = false, setMobileOpen }) => {
  ...
  return (
    <>
      ...
      >
        {/* Brand Header */}
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-800 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white shadow-sm">
          <Link href="/dashboard" className="flex items-center gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-teal-500/20 border border-teal-500/40 p-1 flex items-center justify-center shrink-0 shadow-sm">
              <img
                src="/icon.png"
                alt="N"
            ...
            return (
              <Link
                ...
                className={`flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-all duration-150 ${
                  item.active
                    ? 'bg-gradient-to-r from-teal-500/10 via-indigo-500/10 to-indigo-500/5 text-teal-700 border-l-4 border-teal-600 shadow-sm font-bold'
          ...
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="relative">
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-teal-600 to-indigo-600 flex items-center justify-center text-xs font-black text-white shadow-sm">
